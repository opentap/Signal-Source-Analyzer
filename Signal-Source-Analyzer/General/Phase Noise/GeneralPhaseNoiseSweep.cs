...
namespace Signal_Source_Analyzer
{
    ...
    public class GeneralPhaseNoiseSweep : SSAXBaseStep
    {
        ...
        //[EnabledIf("EnableSearch", false, HideIfDisabled = false)]
        ...
        public override void Run()
        {
            ...
            if ((NoiseType == PhaseNoise_NoiseTypeEnum.PNOise) || (NoiseType == PhaseNoise_NoiseTypeEnum.RESidual))
            {
                SSAX.SetPhaseNoise_CarrierFrequency(Channel, CarrierFrequency);
                if (NoiseType == PhaseNoise_NoiseTypeEnum.PNOise) SSAX.SetPhaseNoise_EnableSearch(Channel, EnableSearch);
